...
export function ComponentRoutoir() {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [isPaused, setIsPaused] = useState(false);
  const slides = [
    {
      src: "/images/Routoir/2.jpg",
      alt: "Routoir",
      legend: "",
    },
    {
      src: "/images/Routoir/3.jpg",
      alt: "Routoir",
      legend: "VII.A.1.003. travail du chanvre au Versoud, coll. CPI",
    },
    {
      src: "/images/Routoir/4.jpg",
      alt: "Routoir",
      legend: "VII.A.1.073. 2004.11.24. Routoir rue Lionel Terray. J.Stéfanini",
    },
  ];
